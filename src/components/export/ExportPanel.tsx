...
export function ExportPanel({ poList }: ExportPanelProps) {
  ...
  const handleExport = () => {
    ...
    toast({
      title: "ส่งออกสำเร็จ",
      description: `ส่งออก ${selectedPOs.length} รายการเป็น C303.xls`,
    });
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-end">
            ...
            >
              ...
              ส่งออก Excel ({selectedPOs.length})
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl border">
        <div className="p-4 border-b flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold">PO พร้อมส่งออก (สถานะ: ตรวจสอบสำเร็จ)</h3>
        ...
        <div className="divide-y">
          {filteredPOs.length === 0 ? (
            <div className="p-8 text-center text-muted-foreground">
              ...
              <p className="text-sm">PO ต้องมีสถานะ "ตรวจสอบสำเร็จ" จึงจะส่งออกได้</p>
            </div>
          ) : (
